...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { description: @faculty.description, name: @faculty.name, user_id: @faculty.user_id } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { description: @faculty.description, name: @faculty.name, user_id: @faculty.user_id } }
